...
namespace PeterDBTesting {
    ...
    TEST_F(RM_Private_Test, read_attributes) {
        ...
        for (int i = 0; i < numTuples; i++) {
            ...
            //nullsIndicator[0] = 255; // 232 e8
            if(i%1000 == 0) { std::cout << "insert, i = " << i << ", nullsIndicator[0]: " << nullsIndicator[0] << std::endl; }
            Tweet tweet;
            ...
            // std::cout << "i = " << i << ", rid is: " << rid.pageNum << " - "<< rid.slotNum << std::endl;
    ...
    TEST_F(RM_Private_Test, scan) {
        ...
        for (int i = 0; i < numTuples; i++) {
            // if(i%1000 == 0) { std::cout << "insert, i = " << i << std::endl; }
            memset(inBuffer, 0, bufSize);
