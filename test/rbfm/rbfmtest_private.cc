...
//            ASSERT_EQ(rbfm.destroyFile(fileName), success) << "Destroying the file should succeed.";
//            ASSERT_EQ(rbfm.createFile(fileName), success) << "Creating the file should succeed: " << fileName;
//            ASSERT_TRUE(fileExists(fileName)) << "The file is not found: " << fileName;
//        }
//        PeterDB::FileHandle fileHandle;
//        ASSERT_EQ(rbfm.openFile(fileName, fileHandle), success)
